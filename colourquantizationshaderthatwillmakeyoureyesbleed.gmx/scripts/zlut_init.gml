...
*/
var _texpalette = argument0, _lutresolution = argument1, _lutcells = argument2;
...
/*
    ...
    _lutcells : number of "cells" in LUT texture. This defines the precision & quality of resulting colour from LUT
*/
var _palettearray = argument0, _lutresolution = argument1, _lutcells = argument2;
...
*/
var _screenwidth = argument0, _screenheight = argument1, _lutresolution = argument2, _lutcellsnum = argument3, _texthreshold = argument4, _texlut1 = argument5, _texlut2 = argument6;
